...
function App() {
  ...
  const [stickyNotes, setStickyNotes] = useState(
    [<StickyNote color={colors[0]}></StickyNote>,
    <StickyNote color={colors[1]}></StickyNote>, 
    <StickyNote color={colors[2]}></StickyNote>,
  ...
  const handleAddNote = () => {
    setNewNote()
    stickyNotes.push(<StickyNote color={colors[Math.floor(Math.random() * colors.length)]} text={text}></StickyNote>)
